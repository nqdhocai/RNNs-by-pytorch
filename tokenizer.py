...
class Tokenizer:
    def __init__(self, vocab=None, token='word', max_length=32):
        ...
        if vocab != None:
            ...
            # cần một corpus để tạo vocab cố định cho token, tuỳ theo từng field mong muốn để chọn corpus phù hợp
            # needed a corpus to create a fixed vocab, depending on each field which was desiderated to choose appropriate corpus
